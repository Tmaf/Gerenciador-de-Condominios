...
public class FuncionarioDaoImpl extends CrudDaoImpl<Funcionario, String> implements FuncionarioDao {
	...
	public FuncionarioDaoImpl() throws RemoteException {
	}
	...
	protected String getConsultaSql(Funcionario modelo) {
		StringBuffer sql = new StringBuffer("from Funcionario where " + "1=1");
	...
	protected Map<String, Object> getParametrosMapa(Funcionario modelo) {
		...
		/*
		 * if(modelo.getHorarioEntrada()!=null){ mapa.put("horarioEntrada",
		 * modelo.getHorarioEntrada()); } if(modelo.getHorarioSaida()!=null){
